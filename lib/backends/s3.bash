...
BK_PIPELINE_SLUG=${BUILDKITE_PLUGIN_CACHE_SLUG_OVERRIDE:-${BUILDKITE_PIPELINE_SLUG}}
...
function restore() {
  ...
  TKEY="${BUILDKITE_ORGANIZATION_SLUG}/${BK_PIPELINE_SLUG}"
...
function cache() {
  TAR_FILE="${CACHE_KEY}.${BK_TAR_EXTENSION}"
  BUCKET="${BUILDKITE_PLUGIN_CACHE_S3_BUCKET}/${BUILDKITE_ORGANIZATION_SLUG}/${BK_PIPELINE_SLUG}"
  TAR_TARGETS=""
